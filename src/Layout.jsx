...
const enterpriseNavItems = [
    { name: 'Account Vinted', icon: Users, page: 'Accounts' },
    { name: 'Social Automation', icon: Sparkles, page: 'SocialAutomation' }
];
                        ...
                        {user?.subscription_plan === 'enterprise' && (
                            <>
                                ...
                                <div className="px-4 py-2">
                                    <p className="text-xs font-semibold text-slate-500 dark:text-slate-400 uppercase">Enterprise</p>
                                </div>
